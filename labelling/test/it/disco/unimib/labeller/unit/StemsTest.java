...
public class StemsTest {
	...
	public void shouldStemASingleWord() throws Exception {
		String stem = new Stems(new IndexFields("dbpedia")).of("movies");
	...
	public void shouldStemAMultipleWords() throws Exception {
		String stem = new Stems(new IndexFields("dbpedia")).of("movie Movie work CreativeWork 1930 films 1930s drama films Black-and-white films Films directed by Alexander Dovzhenko Films set in Ukraine Dovzhenko Film Studios films Soviet silent films Soviet-era Ukrainian films Soviet films Ukrainian films");
