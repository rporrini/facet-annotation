...
cd $root
./index.sh geonames geonames/types "http://www.geonames.org/ontology#featureCode"
./index.sh geonames-ontologies geonames/labels 'http://www.w3.org/2004/02/skos/core#prefLabel'
./index.sh linkedbrainz linkedbrainz/types "http://www.w3.org/1999/02/22-rdf-syntax-ns#type"
